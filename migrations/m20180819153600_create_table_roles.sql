...
CREATE TABLE roles(
    id bigserial,
    organization_id  bigserial NOT NULL REFERENCES Organization(id) ON DELETE CASCADE,
    persongroup_id   bigserial NOT NULL REFERENCES PersonGroup(id),
    servergroup_id   bigserial NOT NULL REFERENCES ServerGroup(id),
    sudoline         TEXT,
