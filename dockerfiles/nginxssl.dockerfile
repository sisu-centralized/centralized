...
ADD dockerfiles/nginxssl/site.conf /etc/nginx/conf.d/default.conf
ADD dockerfiles/nginxssl/init_nginxssl.sh /usr/local/bin/
RUN chmod 0555 /usr/local/bin/init_nginxssl.sh
CMD /usr/local/bin/init_nginxssl.sh
